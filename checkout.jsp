<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="java.util.List, com.DAO.CartDAOImpl, com.DB.DBConnect, com.entity.Cart, com.entity.User"%>
...
<body style="background-color: #f7f7f7;">
	...
	<div class="container">
		<div class="row p-2">
			...
			<!-- Your form code for order details -->
				...
				<div class="card">
					<div class="card-body">
						...
						<input type="hidden" value="${userobj.id }" name="id">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputPhone">Phone Number</label> <input name="phno"
							...
							<div class="form-group">
								<label>Payment Mode</label> <select class="form-control" name="paymemt">
